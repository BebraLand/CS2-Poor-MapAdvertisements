...
Check(AdvertisementVisibilityRules.ShouldHide(false, false, "advert_decals_"), "Emergency hides decals");
Check(AdvertisementVisibilityRules.ShouldHide(false, false, "advert_prop1"), "Emergency hides props");
Check(!AdvertisementVisibilityRules.ShouldHide(false, false, "map_decoration"), "Emergency keeps unrelated entities");
Check(!AdvertisementVisibilityRules.ShouldHide(true, false, "advert_decals_"), "Visible adverts stay visible");
Check(AdvertisementVisibilityRules.ShouldHide(true, true, "advert_decals__force"), "VIP filtering preserved");
